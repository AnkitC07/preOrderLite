...
import CanCodeIo from "./components/tabs/CanCodeIo";
import Design from "./components/tabs/Design";
import Missing from "./components/tabs/Missing";
import Plan from "./components/tabs/Plan";
import Product from "./components/tabs/Product/Product";
import SetuuGuide from "./components/tabs/SetuuGuide";
...
export default function Routes({ pages }) {
  ...
  return (
    <ReactRouterRoutes>
      ...
      <Route path="/Setup" element={<SetuuGuide />} />
      <Route path="/Plan" element={<Plan />} />
      <Route path="/Cancode" element={<CanCodeIo />} />
